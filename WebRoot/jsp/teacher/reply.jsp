...
<form name="reply" action="replyQuestion.action" method="post">
<table align="center" border="1px"  width="60%" height="235"  >
	<tr>
		<th colspan="4" height="34" >查看</th>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td width="230">${question.name}
	  </td>
	</tr>	
	<tr>
		<td width="120" height="32">描述：</td>
	  <td width="230">${question.text}
	  </td>
    </tr>
	<tr>
		<td width="120" height="32">回复：</td>
	  <td width="230">
